...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/RealityLink-Tech/MoonHub/tree/dev/skills/test",
			wantOwner:    "RealityLink-Tech",
			wantRepoName: "MoonHub",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/RealityLink-Tech/MoonHub/blob/main/README.md",
			wantOwner:    "RealityLink-Tech",
			wantRepoName: "MoonHub",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/RealityLink-Tech/MoonHub",
			wantOwner:    "RealityLink-Tech",
			wantRepoName: "MoonHub",
			wantRef:      "main",
			wantSubPath:  "",
